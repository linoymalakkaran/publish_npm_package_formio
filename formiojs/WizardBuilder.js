  ...
  _createClass(WizardBuilder, [{
    ...
    value: function attach(element) {
      ...
      this.refs.gotoPage.forEach(function (link, index) {
        ...
        _this3.addEventListener(link, 'dblclick', function (event) {
          event.preventDefault();
          var pagename = prompt("Please enter your page name",  _this3.form.components[index].title);

          if (pagename != null) {
            _this3.form.components[index].title = pagename;
